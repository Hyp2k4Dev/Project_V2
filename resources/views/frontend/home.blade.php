...
<head>
    <title>HTH SHOPs</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">

    <link rel="stylesheet" href="{{ asset('css/fe/open-iconic-bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/aos.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/ionicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/bootstrap-datepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/jquery.timepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('css/fe/icomoon.css') }}">
...
<body class=" goto-here">
            ...
            <div class="slider-item js-fullheight">
                ...
                <div class="container-fluid p-0">
                    <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                        <img class="one-third order-md-last img-fluid" src="{{ asset('images/bg_1.jpg') }}" alt="">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product d-flex flex-column">
                        <a href="#" class="img-prod"><img class="img-fluid" src="{{asset('images/product-1.png')}}" alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                    <div class="product d-flex flex-column">
                        <a href="#" class="img-prod"><img class="img-fluid" src="{{asset('images/product-2.png')}}" alt="Colorlib Template">
                            <a href="#" class="img-prod"><img class="img-fluid" src="{{asset('images/product-2.png')}}" alt="Colorlib Template">
    ...
    <script href="{{ asset('js/jquery-migrate-3.0.1.min.js') }}"></script>
    <script href="{{ asset('js/popper.min.js') }}"></script>
    <script href="{{ asset('js/bootstrap.min.js') }}"></script>
    <script href="{{ asset('js/jquery.easing.1.3.js') }}"></script>
    <script href="{{ asset('js/jquery.waypoints.min.js') }}"></script>
    <script href="{{ asset('js/jquery.stellar.min.js') }}"></script>
    <script href="{{ asset('js/owl.carousel.min.js') }}"></script>
    <script href="{{ asset('js/jquery.magnific-popup.min.js') }}"></script>
    <script href="{{ asset('js/aos.js') }}"></script>
    <script href="{{ asset('js/jquery.animateNumber.min.js') }}"></script>
    <script href="{{ asset('js/bootstrap-datepicker.js') }}"></script>
    <script href="{{ asset('js/scrollax.min.js') }}"></script>
    <script href="{{ asset('js/google-map.js') }}"></script>
