            ...
            <div id="carousel-related-product">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white" href="productdetails.blade.php"><i class="far fa-heart"></i></a></li>
                                    <li><a class="btn btn-success text-white mt-2" href="productdetails.blade.php"><i class="far fa-eye"></i></a></li>
                                    <li><a class="btn btn-success text-white mt-2" href="productdetails.blade.php"><i class="fas fa-cart-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="productdetails.blade.php" class="h3 text-decoration-none">Red Clothing</a>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="productdetails.blade.php" class="h3 text-decoration-none">White Shirt</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="productdetails.blade.php" class="h3 text-decoration-none">Oupidatat non</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="productdetails.blade.php" class="h3 text-decoration-none">Black Fashion</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
